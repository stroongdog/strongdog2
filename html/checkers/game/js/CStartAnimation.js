function CStartAnimation(oParentContainer, aWhiteFinalPos, aBlackFinalPos, oAnimationContainer, bBlackTop){
    ...
    this._init = function(oParentContainer, aWhiteFinalPos, aBlackFinalPos, oAnimationContainer, bBlackTop){
        ...
        for(var i=0; i<_iNumChips; i++){
            ...
            if(bBlackTop){
                ...
                _aBlackChips[i].x = 80 + i*iOffset;
                _oBotContainer.addChild(_aBlackChips[i]);
            }
            //_oTopContainer.addChild(_aBlackChips[i]);
        }
        ...
        for(var i=0; i<_iNumChips; i++){
            ...
            if(bBlackTop){
                ...
                _aWhiteChips[i].x = -160 - i*iOffset;
                _oTopContainer.addChild(_aWhiteChips[i]);
            }
    ...
    var _oParent = this;
    this._init(oParentContainer, aWhiteFinalPos, aBlackFinalPos, oAnimationContainer, bBlackTop);
}
